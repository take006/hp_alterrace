    ...
    <section class="footer">
      ...
      <div class="footer-policy">
            <ul class="footer-policy-list">
              <li class="footer-policy-list-item"><a href="<?= BASE_URL ?>app/views/others/privacy/index.php">プライバシーポリシー</a></li>
              <li class="footer-policy-list-item"><a href="<?= BASE_URL ?>app/views/others/sitePolicy/index.php">サイトポリシー</a></li>
            </ul>
          </div>
      <div class="footer_copy-right-wrapper">
